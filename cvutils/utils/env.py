...
def collect_env():
    ...
    if cuda_available:
        ...
        from cvutils.utils.parrots_wrapper import _get_cuda_home
    ...
    env_info['MMCV'] = cvutils.__version__

    try:
        from cvutils.ops import get_compiler_version, get_compiling_cuda_version
    except ModuleNotFoundError:
