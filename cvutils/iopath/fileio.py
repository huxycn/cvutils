...
from .handlers import BaseFileHandler, ImgHandler, CsvHandler, JsonHandler, PickleHandler, YamlHandler
...
def load(file: Union[str, Path, FileLikeObject],
    ...
    Args:
        ...
        file_client_args (dict, optional): Arguments to instantiate a
            FileClient. See :class:`cvutils.fileio.FileClient` for details.
            Default: None.
    ...
    if isinstance(file, str):
        ...
        elif handler.for_img:
            obj = handler.load_from_fileobj(file_client.get(file), **kwargs)
        else:
...
def dump(obj: Any,
    ...
    if file is None:
        ...
        if handler.str_like:
            ...
            file_client.put(handler.dump_to_fileobj(obj, **kwargs), file)
        else:
            with BytesIO() as f:
                handler.dump_to_fileobj(obj, f, **kwargs)
