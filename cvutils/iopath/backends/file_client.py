...
from .obs_backend import ObsBackend
...
class FileClient:
    ...
    def is_dir(self, filepath: Union[str, Path]) -> bool:
        ...
        Returns:
            ...
            ``False`` otherwise.
        """
        return self.client.is_dir(filepath)
    ...
    def is_file(self, filepath: Union[str, Path]) -> bool:
        ...
        Returns:
            ...
            otherwise.
        """
        return self.client.is_file(filepath)
    ...
    def list_dir(self,
                 dir_path: str,
                 suffix: str = None):
        yield from self.client.list_dir(dir_path, suffix)

    def with_tag_suffix(self,
                        path: str,
                        tag: str,
                        suffix: str,
                        **kwargs) -> str:
        return self.client.with_tag_suffix(path, tag, suffix)

    def dirname(self, path):
        return self.client.dirname(path)

    def basename(self, path):
        return self.client.basename(path)

    def join(self, path, *paths, auto_mkdir=True):
        return self.client.join(path, *paths, auto_mkdir=auto_mkdir)
